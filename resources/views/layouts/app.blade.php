...
<head>
  ...
  <link rel="stylesheet" media="only screen and (max-width: 768px)" href="{{asset('css/responsive.css')}}">
...
<body>
  ...
  <div id="app">
    <nav class="navbar navbar-expand-md navbar-dark bg-primary " style="z-index: 19 !important;">
      <div class="container">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fa fa-user me-3 text-secondary"></i> guillerhuguet@gmail.com</p>
